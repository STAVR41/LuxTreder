...
let slider_about = new Swiper('.mainSlider__body', {
   ...
   */
   ...
   // Arrows
   navigation: {
      nextEl: '.control-mainSlider__right',
      prevEl: '.control-mainSlider__left',
   },
   /*
   breakpoints: {
      320: {
...
let slider_sw = new Swiper('.slider-lots__body', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
...
let mark_sw = new Swiper('.mark__body', {
...
let header_icon = document.querySelector('.pop-header__icon');
header_icon.addEventListener("click", function (e) {
   let pop_menu = document.querySelector('.pop-header__list');
   pop_menu.classList.toggle('_active');
});
document.documentElement.addEventListener("click", function (e) {
   if (!e.target.closest('.pop-header')) {
      let pop_menu = document.querySelector('.pop-header__list');
      pop_menu.classList.remove('_active');
   }
});
